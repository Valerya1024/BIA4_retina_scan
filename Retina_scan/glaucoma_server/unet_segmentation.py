...
c5 = Conv2D(128, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same') (u5)
c5 = Dropout(0.2) (c5)
...
results = model.fit(train_data, train_mask, validation_split=0.1, batch_size=20, epochs=10, 
